...
/**
 * This component will used as a directive to be used at elements that we wants to animate.
 * Desined from - https://medium.com/wizdm-genesys/animate-on-scroll-in-angular-330efd05ebec
 * gitHUb - 
 */
@Component({
  selector: '[wmAnimate]',
